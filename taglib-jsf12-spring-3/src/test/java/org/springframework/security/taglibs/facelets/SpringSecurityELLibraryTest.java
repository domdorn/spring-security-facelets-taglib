...
public class SpringSecurityELLibraryTest {
  ...
  public void setUp() {
    ...
    Authentication auth = new PreAuthenticatedAuthenticationToken(principal, new Object(),
  ...
  /*
   * test if ROLE_ADMIN is not granted, as it is by our test data, this should
   * return false
   */
  ...
  /*
   * test if ROLE_VISITOR is not granted, as this is not within our default test
   * data, this should return true
   */
  @Test
